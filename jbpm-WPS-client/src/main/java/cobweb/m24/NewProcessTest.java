...
public class NewProcessTest {
	 ...
	 * @param args
	 * 
	 * This is a test class for the Eclipse plugin.
	 * Workflow processes can be setup programmatically and run outside of the console and run here.
	 * To use this class, make sure JBPM workflow plugins are installed using the Ant script.
	 */
	...
	/**
	 * use this to start a defined process, this can be found in /src/main/resources
	 */
