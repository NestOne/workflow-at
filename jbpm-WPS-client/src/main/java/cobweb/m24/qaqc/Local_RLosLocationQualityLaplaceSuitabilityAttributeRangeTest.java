...
public class Local_RLosLocationQualityLaplaceSuitabilityAttributeRangeTest {
	...
	public static void main(String args[]) {
		 ...
		 * /src/main/resources
		 */
		ksession.startProcess("cobweb.m24.qaqc.local_qaqc_knotweed_los_locationquality_laplace_suitability_attributerange");
	}
