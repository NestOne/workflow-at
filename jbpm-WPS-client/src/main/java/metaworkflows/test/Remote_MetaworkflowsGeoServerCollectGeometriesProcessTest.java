...
public class Remote_MetaworkflowsGeoServerCollectGeometriesProcessTest {
	/**
	...
	public static void main(String args[]) {
		 ...
		 * /src/main/resources
		 */
		ksession.startProcess("metaworkflows.test.remote_metaworkflow_geoserver_collect_geometries_wps");
	}
