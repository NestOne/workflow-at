...
public class Local_MetaworkflowsGeoServerBufferChainTest {
	/**
	...
	public static void main(String args[]) {
		 ...
		 * /src/main/resources
		 */
		ksession.startProcess("metaworkflows.test.local_metaworkflow_geoserver_buffer_chain");
	}
