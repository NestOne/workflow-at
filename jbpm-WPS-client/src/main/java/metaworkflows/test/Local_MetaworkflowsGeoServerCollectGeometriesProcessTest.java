...
public class Local_MetaworkflowsGeoServerCollectGeometriesProcessTest {
	/**
	...
	public static void main(String args[]) {
		 ...
		 * /src/main/resources
		 */
		ksession.startProcess("metaworkflows.test.local_metaworkflow_geoserver_collect_geometries_wps");
	}
