...
public class Local_MetaworkflowsGeoServerHeatmapRemoteDataTest {
	/**
	...
	public static void main(String args[]) {
		 ...
		 * /src/main/resources
		 */
		ksession.startProcess("metaworkflows.test.local_metaworkflow_geoserver_heatmap_remote_data");
	}
