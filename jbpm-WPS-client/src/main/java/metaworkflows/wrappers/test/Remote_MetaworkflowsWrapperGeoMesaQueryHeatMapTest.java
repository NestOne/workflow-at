...
public class Remote_MetaworkflowsWrapperGeoMesaQueryHeatMapTest {
	/**
	...
	public static void main(String args[]) {
		 ...
		 * /src/main/resources
		 */
		ksession.startProcess("metaworkflows.wrappers.test.remote_metaworkflow_wrapper_geomesa_query_heatmap");
